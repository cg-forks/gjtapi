...
public class Unsupport implements CallCommandSend {
    ...
    public void run() {
        try {
            ProtocolControlFrame unsupportFrame = new ProtocolControlFrame(call.
                    getSrcCallNo(), false, call.getDestCallNo(),
                    call.getTimestamp(), call.getOseqno(), call.getIseqno(), false,
                    ProtocolControlFrame.UNSUPPORT_SC);
